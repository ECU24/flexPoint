...
class FridayExerciseEditScreen extends StatefulWidget {
  final String exerciseTypeName;
  const FridayExerciseEditScreen({super.key, required this.exerciseTypeName});

  @override
  State<FridayExerciseEditScreen> createState() =>
      _FridayExerciseEditScreenState();
}

class _FridayExerciseEditScreenState extends State<FridayExerciseEditScreen> {
  ...
  void save() async {
    ...
    Provider.of<FridayExerciseData>(context, listen: false).addExercise(
    ...
    showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              actions: [
                MaterialButton(
                  onPressed: () async {
                    Provider.of<FridayExerciseData>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    return Consumer<FridayExerciseData>(

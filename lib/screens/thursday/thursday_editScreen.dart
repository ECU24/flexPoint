...
class ThursdayExerciseEditScreen extends StatefulWidget {
  final String exerciseTypeName;
  const ThursdayExerciseEditScreen({super.key, required this.exerciseTypeName});

  @override
  State<ThursdayExerciseEditScreen> createState() =>
      _ThursdayExerciseEditScreenState();
}

class _ThursdayExerciseEditScreenState
    extends State<ThursdayExerciseEditScreen> {
  ...
  void save() async {
    ...
    Provider.of<ThursdayExerciseData>(context, listen: false).addExercise(
    ...
    showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              actions: [
                MaterialButton(
                  onPressed: () async {
                    Provider.of<ThursdayExerciseData>(context, listen: false)
              ...
              appBar: AppBar(
                ...
                leading: IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ThursdayScreen()),
                    );
                  },
                ),
              ),

...
class SundayExerciseEditScreen extends StatefulWidget {
  final String exerciseTypeName;
  const SundayExerciseEditScreen({super.key, required this.exerciseTypeName});

  @override
  State<SundayExerciseEditScreen> createState() =>
      _SundayExerciseEditScreenState();
}

class _SundayExerciseEditScreenState extends State<SundayExerciseEditScreen> {
  ...
  void save() async {
    ...
    Provider.of<SundayExerciseData>(context, listen: false).addExercise(
    ...
    showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              actions: [
                MaterialButton(
                  onPressed: () async {
                    Provider.of<SundayExerciseData>(context, listen: false)

...
class SaturdayExerciseEditScreen extends StatefulWidget {
  final String exerciseTypeName;
  const SaturdayExerciseEditScreen({super.key, required this.exerciseTypeName});

  @override
  State<SaturdayExerciseEditScreen> createState() =>
      _SaturdayExerciseEditScreenState();
}

class _SaturdayExerciseEditScreenState
    extends State<SaturdayExerciseEditScreen> {
  ...
  void save() async {
    ...
    Provider.of<SaturdayExerciseData>(context, listen: false).addExercise(
    ...
    showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              actions: [
                MaterialButton(
                  onPressed: () async {
                    Provider.of<SaturdayExerciseData>(context, listen: false)
  ...
  Widget build(BuildContext context) {
    return Consumer<SaturdayExerciseData>(
              ...
              appBar: AppBar(
                ...
                leading: IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => SaturdayScreen()),
                    );
                  },
                ),
              ),

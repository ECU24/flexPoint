...
class WednesdayExerciseEditScreen extends StatefulWidget {
  final String exerciseTypeName;
  const WednesdayExerciseEditScreen(
      {super.key, required this.exerciseTypeName});

  @override
  State<WednesdayExerciseEditScreen> createState() =>
      _WednesdayExerciseEditScreenState();
}

class _WednesdayExerciseEditScreenState
    extends State<WednesdayExerciseEditScreen> {
  ...
  void save() async {
    ...
    // Check if userID is null (user not found)
    if (userID == null) {
    ...
    Provider.of<WednesdayExerciseData>(context, listen: false).addExercise(
    ...
    showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              actions: [
                MaterialButton(
                  onPressed: () async {
                    Provider.of<WednesdayExerciseData>(context, listen: false)
                    ...
                    try {
                      await FirebaseFirestore.instance
                          ...
                          .doc(exerciseID) // Update specific exercise
                          .update({
  ...
  Widget build(BuildContext context) {
    return Consumer<WednesdayExerciseData>(
